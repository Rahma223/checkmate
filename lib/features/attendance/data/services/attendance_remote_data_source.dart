...
class AttendanceRemoteDataSource {
  ...
  Future<List<dynamic>> getHistory({
    ...
    if (status != null && status != 'all') {
      queryParameters["filter[status][_eq]"] = status;
    }
  ...
  Future<Map<String, dynamic>?> getTodayRecord({required String userId}) async {
    ...
    print(
      'AttendanceRemoteDataSource.getTodayRecord response=${response.data}',
    );
  ...
  /// Returns the active break (end_time is null) for the given attendance id, or null if none.
