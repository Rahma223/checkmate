          ...
          body: state.isLoading
              ...
              : Column(
                  children: [
                    ...
                    Expanded(child: _DayDetail(state: state)),
                  ],
                ),
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _Legend(color: AppColors.primary, label: 'Work Shift'),
              const SizedBox(width: 16),
              _Legend(color: AppColors.warning, label: 'Leave'),
              const SizedBox(width: 16),
              _Legend(
    ...
    return ListView(
      ...
      children: [
        ...
        if (isWknd)
          ...
          ...shifts.map((s) => _ShiftCard(shift: s)),
          ...leaves.map((l) => _LeaveIndicator(leave: l)),
        ],
      ],
    );
  }
...
class _LeaveIndicator extends StatelessWidget {
  final LeaveEntity leave;
  const _LeaveIndicator({required this.leave});
