...
class _NotifTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
    onTap: onTap,
    child: Container(
      color: item.isRead ? Colors.transparent : AppColors.primaryFixed.withOpacity(0.15),
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Expanded(child: Text(item.title,
                style: TextStyle(
                  fontSize: 14, fontWeight: item.isRead ? FontWeight.w500 : FontWeight.w700,
          ...
          Text(item.body, style: const TextStyle(fontSize: 12, color: AppColors.onSurfaceVariant),
